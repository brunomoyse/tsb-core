        ...
        <div v-if="!isCollapsed" class="mt-3">
            <div class="relative">
                <input
                    ...
                    class="w-full px-3 py-2.5 pr-9 bg-white border border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-400 tabular-nums focus-visible:ring-2 focus-visible:ring-ygf-orange-300/50 focus-visible:border-ygf-orange-300 focus-visible:outline-none transition-all duration-300"
                />
