...
<template>
    <Transition name="fade-up">
        <button
            ...
            class="scroll-top-btn fixed right-4 z-30 w-10 h-10 rounded-full shadow-md flex items-center justify-center transition-all active:scale-95 text-ygf-white"
