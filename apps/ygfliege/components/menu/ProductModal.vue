            ...
            <div v-if="p" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex gap-2 flex-wrap">
                        ...
                        <span v-if="p.isSpicy" class="px-3 py-1 bg-ygf-orange-100 text-ygf-orange-800 text-sm rounded-full inline-flex items-center gap-1.5">
                            <img
                        ...
                        <span v-if="p.isLunchOnly" class="px-3 py-1 bg-ygf-orange-100 text-ygf-orange-700 text-sm rounded-full inline-flex items-center gap-1.5">
                            {{ $t('menu.lunchOnly') }}
                        </span>
                    ...
                    <div v-if="hasChoices" class="space-y-3 border-t pt-4">
                        ...
                        <div class="space-y-3">
                            <div
                                ...
                                :class="isGroupSatisfied(group) ? 'border-gray-200' : 'border-ygf-orange-300 bg-ygf-orange-50/30'"
                            >
                                <div class="flex items-center justify-between mb-2 gap-3">
                                    <div class="min-w-0">
                                        ...
                                        <p
                                            ...
                                            class="text-xs text-ygf-orange-600 mt-0.5"
                                        >
                                            {{ groupHint(group) }}
                                        </p>
                                    </div>
                                    <span
                                        ...
                                        :class="isGroupSatisfied(group) ? 'text-emerald-600' : 'text-ygf-orange-600'"
                                    >
                    ...
                    <div class="space-y-4 border-t pt-4">
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <button
                                ...
                                class="flex-1 bg-ygf-orange-500 hover:bg-ygf-orange-600 text-white px-6 py-3 rounded-lg text-sm md:font-medium transition-all active:scale-[0.97]"
