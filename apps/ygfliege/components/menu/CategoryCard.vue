<template>
    <button
        ...
        :class="active
            ? 'bg-ygf-orange-100 text-ygf-orange-900/80 font-semibold'
            : 'text-gray-400 font-medium hover:bg-ygf-orange-100/40 hover:text-gray-500'"
        @click="handleClick"
        :data-id="category.id"
    >
        {{ displayName }}
        ...
        <span
            class="absolute bottom-0 left-0 right-0 h-[2.5px] bg-ygf-orange-400 transition-all duration-300 ease-out origin-center"
