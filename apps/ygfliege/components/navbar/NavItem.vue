    ...
    <li>
        ...
        >
            ...
            <div :class="[
                ...
                <span class="absolute -bottom-1 left-1/2 -translate-x-1/2 w-5 h-0.5 bg-ygf-orange-500 rounded-full transition-transform duration-200 ease-out origin-center"
