<template>
    <li ref="rootRef" class="relative">
        ...
        <button type="button" data-testid="language-picker" class="relative group min-h-11 min-w-11 w-[50px] h-[50px] bg-white flex items-center justify-center rounded-full hover:shadow-md transition-shadow overflow-visible cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
