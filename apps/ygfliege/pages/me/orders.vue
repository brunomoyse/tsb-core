                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                ...
                                :class="isOrderCompleted(order.status) ? getStatusColorClass(order.status) : 'text-ygf-orange-600 bg-ygf-orange-100'"
                            >
                ...
                >
                    <div :id="`order-panel-${order.id}`" v-show="isExpanded(order.id)" class="px-5 sm:px-6 pb-5 sm:pb-6">
                        ...
                        <div
                            ...
                            class="mb-3 p-3 bg-ygf-orange-50/70 rounded-xl"
                        >
                        ...
                        <button
                            ...
                            type="button"
                            class="mt-3 w-full min-h-11 rounded-xl bg-ygf-orange-500 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-ygf-orange-600 focus:outline-none focus:ring-2 focus:ring-ygf-orange-300"
                            @click="reorder(order)"
                        >
                            {{ $t('reorder.button') }}
                        </button>
