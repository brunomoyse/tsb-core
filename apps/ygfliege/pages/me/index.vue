...
<template>
    <section class="max-w-5xl mx-auto pt-6 sm:pt-8 pb-8 px-2">
        ...
        <div class="text-center mb-6 sm:mb-8 bento-cell" style="--delay: 0">
            ...
            <p class="mt-1 text-xs text-ygf-orange-300/40 tracking-[0.25em]" aria-hidden="true">ようこそ</p>
        </div>
        ...
        <div class="bento-grid">
            ...
            <div class="bento-profile bento-cell" style="--delay: 1">
                <div class="bg-ygf-cream rounded-2xl p-6 sm:p-7 h-full flex flex-col items-center justify-center text-center">
                    <div class="w-16 h-16 rounded-full bg-white flex items-center justify-center mb-4">
                        <span class="text-xl font-bold text-ygf-orange-400">{{ initials }}</span>
                    </div>
                    <h2 class="font-semibold text-gray-900 text-base">{{ fullName }}</h2>
                    <button
                        type="button"
                        class="mt-4 inline-flex min-h-11 items-center gap-1.5 rounded-lg px-2 text-xs font-medium text-gray-500 hover:text-ygf-orange-500 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
                        @click="openModal"
                    >
            ...
            <div class="bento-email bento-cell" style="--delay: 2">
                <div class="bg-ygf-cream rounded-2xl p-6 h-full flex flex-col">
            ...
            <div class="bento-phone bento-cell" style="--delay: 3">
                <div class="bg-ygf-cream rounded-2xl p-6 h-full flex flex-col">
                    ...
                    <a
                        ...
                        class="inline-flex min-h-11 items-center text-sm text-gray-900 mt-1 hover:text-ygf-orange-500 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300 rounded-md"
                    >
                    ...
                    <div class="mt-3">
                        <div class="flex items-center gap-3">
                            <button
                                ...
                                :class="notifyMarketing ? 'bg-ygf-orange-400' : 'bg-gray-200'"
                    ...
                    <div class="mt-4 pt-4 border-t border-white/60">
                        <div class="flex items-center gap-3">
                            <button
                                ...
                                class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ygf-orange-400 focus:ring-offset-2"
                                :class="notifyOrderUpdates ? 'bg-ygf-orange-400' : 'bg-gray-200'"
            ...
            <div class="bento-logout bento-cell self-start" style="--delay: 9">
                <button
                    type="button"
                    class="bg-ygf-cream rounded-2xl p-6 w-full flex flex-col text-left hover:bg-ygf-orange-50 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
                    @click="handleLogout"
                >
                    <div class="w-8 h-8 rounded-full bg-white flex items-center justify-center mb-3">
        ...
        <div class="mt-8 text-center bento-cell" style="--delay: 11">
            <button
                type="button"
                class="inline-flex min-h-11 items-center text-xs text-gray-400 hover:text-ygf-orange-500 transition rounded-md px-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
                ...
                >
                    ...
                    <label class="mb-4 flex items-start gap-2.5 cursor-pointer select-none">
                        <input
                            ...
                            type="checkbox"
                            class="mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 text-ygf-orange-600 focus:ring-2 focus:ring-ygf-orange-300"
                        >
