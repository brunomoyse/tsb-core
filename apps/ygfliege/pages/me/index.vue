...
<template>
    <section class="max-w-5xl mx-auto pt-6 sm:pt-8 pb-8 px-2">
        ...
        <div class="text-center mb-6 sm:mb-8 bento-cell" style="--delay: 0">
            ...
            <p class="mt-2 text-sm sm:text-base text-ygf-gray-600 font-light">{{ t('me.subtitle') }}</p>
        </div>
        ...
        <div class="bento-grid">
            ...
            <div class="bento-profile bento-cell" style="--delay: 1">
                <div class="card rounded-2xl p-6 sm:p-7 h-full flex flex-col items-center justify-center text-center">
                    <div class="w-16 h-16 rounded-full bg-ygf-white flex items-center justify-center mb-4" style="border-color: rgba(242, 123, 32, 0.12); border-width: 2px">
                        <span class="text-xl font-bold" style="color: var(--ygf-orange-on-white)">{{ initials }}</span>
                    </div>
                    <h2 class="font-semibold text-ygf-black text-base">{{ fullName }}</h2>
                    <button
                        type="button"
                        class="mt-4 inline-flex min-h-11 items-center gap-1.5 rounded-lg px-2 text-xs font-medium transition focus:outline-none focus-visible:ring-2"
                        style="color: var(--ygf-gray-600); focus-visible:ring-color: rgba(242, 123, 32, 0.3)"
                        @click="openModal"
                    >
            ...
            <div class="bento-email bento-cell" style="--delay: 2">
                <div class="card rounded-2xl p-6 h-full flex flex-col">
                    ...
                    <span class="text-xs text-ygf-gray-600 uppercase tracking-wider">{{ t('me.profile.email') }}</span>
                    <span class="text-sm text-ygf-black mt-1 break-all">{{ authStore.user?.email || '–' }}</span>
            ...
            <div class="bento-phone bento-cell" style="--delay: 3">
                <div class="card rounded-2xl p-6 h-full flex flex-col">
                    ...
                    <span class="text-xs text-ygf-gray-600 uppercase tracking-wider">{{ t('me.profile.phoneNumber') }}</span>
                    <a
                        v-if="authStore.user?.phoneNumber"
                        :href="`tel:${authStore.user.phoneNumber}`"
                        class="inline-flex min-h-11 items-center text-sm text-ygf-black mt-1 hover:text-ygf-orange-500 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300 rounded-md"
                    >
                        {{ authStore.user.phoneNumber }}
                    </a>
                    <span v-else class="text-sm text-ygf-gray-500 mt-1">–</span>
                </div>
            </div>
            ...
            <div class="bento-address bento-cell" style="--delay: 4">
                <div class="card rounded-2xl p-6 h-full flex flex-col">
                    ...
                    <span class="text-xs text-ygf-gray-600 uppercase tracking-wider">{{ t('me.profile.address') }}</span>
                    <span v-if="authStore.user?.address" class="text-sm text-ygf-black mt-1 whitespace-pre-line">
                        {{ formatAddress(authStore.user.address) }}
                    </span>
                    <button
                        type="button"
                        class="mt-2 min-h-11 text-sm text-ygf-orange-500 hover:text-ygf-orange-600 transition text-left rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
            ...
            <div class="bento-notifications bento-cell" style="--delay: 6">
                <div class="card rounded-2xl p-6 h-full flex flex-col">
                    ...
                    <span class="text-xs text-ygf-gray-600 uppercase tracking-wider">{{ t('me.notifications.title') }}</span>
                    ...
                    <div class="mt-3">
                        <div class="flex items-center gap-3">
                            <button
                                ...
                                class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ygf-orange-400 focus:ring-offset-2"
                                :class="notifyMarketing ? 'bg-ygf-orange-400' : 'bg-ygf-gray-200'"
                            ...
                            <span class="text-sm text-ygf-black">{{ t('me.notifications.marketingLabel') }}</span>
                        </div>
                        <p class="text-xs text-ygf-gray-500 mt-1.5">{{ t('me.notifications.marketingDescription') }}</p>
                    </div>
                    ...
                    <div class="mt-4 pt-4 border-t border-white/60">
                        <div class="flex items-center gap-3">
                            <button
                                ...
                                class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ygf-orange-400 focus:ring-offset-2"
                                :class="notifyOrderUpdates ? 'bg-ygf-orange-400' : 'bg-ygf-gray-200'"
                            ...
                            <span class="text-sm text-ygf-black">{{ t('me.notifications.orderUpdatesLabel') }}</span>
                        </div>
                        <p class="text-xs text-ygf-gray-500 mt-1.5">{{ t('me.notifications.orderUpdatesDescription') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bento-language bento-cell" style="--delay: 8">
                <div class="card rounded-2xl p-6 h-full flex flex-col">
                    ...
                    <span class="text-xs text-ygf-gray-600 uppercase tracking-wider">{{ t('nav.language') }}</span>
                    <div class="flex flex-wrap gap-2 mt-2">
                        <NuxtLink
                            ...
                            :class="[
                                'inline-flex min-h-11 items-center justify-center px-3 py-1.5 text-sm rounded-full transition-all active:scale-[0.97] focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300',
                                locale === lang.code
                                    ? 'bg-ygf-orange-500 text-white font-medium'
                                    : 'bg-white text-ygf-gray-600 hover:bg-ygf-gray-100'
                            ]"
                        >
                            {{ lang.label }}
                        </NuxtLink>
            ...
            <div class="bento-logout bento-cell self-start" style="--delay: 9">
                <button
                    type="button"
                    class="card rounded-2xl p-6 w-full flex flex-col text-left hover:bg-ygf-gray-50 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
                    @click="handleLogout"
                >
                    <div class="w-8 h-8 rounded-full bg-white flex items-center justify-center mb-3">
                        <svg class="w-4 h-4 text-ygf-orange-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9"/>
                        </svg>
                    </div>
                    <span class="text-sm font-medium text-ygf-orange-500">{{ t('nav.logout') }}</span>
                </button>
            </div>
        ...
        <div class="mt-8 text-center bento-cell" style="--delay: 11">
            <button
                type="button"
                class="inline-flex min-h-11 items-center text-xs text-ygf-gray-500 hover:text-ygf-orange-500 transition rounded-md px-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
        ...
        <transition name="fade">
            ...
            >
                ...
                >
                    <h3 id="delete-account-title" class="text-xl font-semibold text-ygf-black text-center mb-3">
                        {{ t('me.profile.deleteConfirmTitle') }}
                    </h3>
                    <p class="text-sm text-ygf-gray-600 text-center mb-4">
                    ...
                    <div class="mb-5 rounded-lg border border-ygf-gray-100 bg-ygf-gray-50 p-3 text-sm text-ygf-gray-600 space-y-2">
                        <p class="flex gap-2">
                            <span aria-hidden="true">🗑️</span>
                    ...
                    <label class="mb-4 flex items-start gap-2.5 cursor-pointer select-none">
                        <input
                            ...
                            type="checkbox"
                            class="mt-0.5 h-4 w-4 shrink-0 rounded border-ygf-border text-ygf-orange-600 focus:ring-2 focus:ring-ygf-orange-300"
                        >
                        <span class="text-sm text-ygf-gray-600">{{ t('me.profile.deleteConfirmCheckbox') }}</span>
                    </label>

                    <p class="text-center mb-5">
                        <NuxtLinkLocale
                            to="/account-deletion"
                            class="text-xs text-ygf-gray-500 underline hover:text-ygf-gray-600 transition"
                        >
                    ...
                    <div class="flex gap-3">
                        <button
                            type="button"
                            :disabled="deleting"
                            class="flex-1 rounded-lg border border-ygf-border px-4 py-2.5 text-ygf-black hover:bg-ygf-gray-50 transition-colors font-medium disabled:opacity-50"
                        ...
                        <button
                            ...
                            class="flex-1 rounded-lg bg-ygf-orange-600 px-4 py-2.5 text-white hover:bg-ygf-orange-700 transition-colors font-medium disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <transition name="fade">
            ...
            >
                <div ref="modalRef" role="dialog" aria-modal="true" aria-labelledby="edit-profile-title" class="bg-white rounded-2xl shadow-xl p-6 max-w-lg w-full mx-4" @click.stop @keydown.esc="closeModal">
                    <h3 id="edit-profile-title" class="text-2xl font-semibold text-ygf-black text-center mb-6">
                        {{ t('me.profile.update') }}
                    </h3>
        ...
        <transition name="fade">
            ...
            >
                <div ref="addressModalRef" role="dialog" aria-modal="true" aria-labelledby="edit-address-title" class="bg-white rounded-2xl shadow-xl p-6 max-w-md w-full mx-4" @click.stop @keydown.esc="closeAddressModal">
                    <h3 id="edit-address-title" class="text-2xl font-semibold text-ygf-black text-center mb-6">
                    ...
                    <div class="flex gap-3 pt-6">
                        <button
                            type="button"
                            class="flex-1 min-h-11 px-4 py-2.5 text-sm font-medium text-ygf-black bg-ygf-gray-100 hover:bg-ygf-gray-200 rounded-xl transition focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
                        ...
                        <button
                            ...
                            class="flex-1 min-h-11 px-4 py-2.5 text-sm font-medium text-white bg-ygf-orange-500 hover:bg-ygf-orange-600 rounded-xl transition disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-ygf-orange-300"
