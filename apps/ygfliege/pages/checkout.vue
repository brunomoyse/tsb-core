<template>
    <div class="max-w-7xl mx-auto p-4 pb-24 lg:pb-4">
        ...
        <div id="checkout-minimum-order-banner" role="alert" aria-live="assertive" aria-atomic="true" tabindex="-1" v-if="!isMinimumReached && cartStore.products.length > 0" class="mb-6 rounded-lg bg-ygf-orange-50 border border-ygf-orange-200 p-4 flex items-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-ygf-orange-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
            </svg>
            <p class="text-ygf-orange-700 font-medium text-sm">
        ...
        <div
            ...
            aria-live="assertive"
            aria-atomic="true"
            class="mb-6 rounded-lg bg-ygf-orange-50 border border-ygf-orange-200 p-4"
        >
            <div class="flex items-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-ygf-orange-500 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
                </svg>
                <div class="flex-1 min-w-0">
                    <p class="text-ygf-orange-800 font-semibold text-sm mb-2">{{ $t('checkout.completeBeforeOrder') }}</p>
                    <ul class="space-y-1.5">
                        <li v-for="err in submitErrors" :key="err.targetId">
                            <button
                                type="button"
                                class="text-left text-sm text-ygf-orange-700 underline underline-offset-2 decoration-ygf-orange-300 hover:text-ygf-orange-800 hover:decoration-ygf-orange-500 focus-visible:ring-2 focus-visible:ring-ygf-orange-300 focus:outline-none rounded"
        ...
        <Teleport v-if="isRedirectingToPayment" to="body">
            ...
            >
                <svg class="animate-spin h-8 w-8 text-ygf-orange-500 mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"/>
                </svg>
