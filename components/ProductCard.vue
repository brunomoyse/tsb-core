        ...
        <div class="flex justify-between items-center mx-2">
          ...
          <template v-if="!showControls">
            ...
            <div>
              ...
              <div
                v-else
                class="flex items-center justify-center w-10 h-10 text-black font-semibold border-2 border-tsb-red rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition disabled:cursor-not-allowed disabled:opacity-50"
