...
<template>
    <nav class="bg-white text-tsb-gray fixed z-50 h-20 w-full">
        <div class="px-4 flex justify-between items-center h-full mx-auto">
            ...
            <NuxtLink href="/">
                <h1 class="flex text-lg items-center font-['Channel'] text-charcoal hover:text-tsb-red">
                    Tokyo
                </h1>
            </NuxtLink>
...
#mobile-menu {
    position: fixed;
    top: 5rem; /* Adjust based on navbar height (h-20 = 5rem) */
    left: 0;
    right: 0;
    bottom: 0;
    ...
    z-index: 40; /* Ensure it's below the navbar (z-50) */
}
