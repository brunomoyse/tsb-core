<template>
    <section class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
        ...
        <p class="text-xs text-red-700 bg-red-50 border border-red-100 rounded-lg px-3 py-2 mb-4 inline-flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            >
                <span class="flex items-center gap-3 min-w-0">
                    ...
                    />
                    <span :class="['text-sm font-medium truncate', isSelected(extra.code) ? 'text-red-700' : 'text-gray-800']">
                        {{ extra.label }}
                    </span>
                </span>
                <span :class="['text-sm font-semibold shrink-0 tabular-nums', isSelected(extra.code) ? 'text-red-700' : 'text-gray-900']">
