<template>
    <div>
        ...
        <div class="min-h-screen flex flex-col">
            ...
            <footer class="p-4 sm:ml-[142px] text-xs text-gray-500">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-gray-200 pt-4">
                    <!-- Left: Address & Phone -->
                    <div class="text-center sm:text-left">
                        <p>{{ $t('contact.address') }}</p>
                        <p>{{ $t('contact.phoneTitle') }}: 04 222 98 88</p>
                    </div>
                    <!-- Center: Hours -->
                    ...
                    <div class="flex flex-col items-center sm:items-end gap-1">
                        <div class="flex items-center gap-3">
                            <a href="https://www.instagram.com/tokyosushi_liege/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span>|</span>
                            <span>by</span>
                            <a class="inline-flex items-center hover:underline" href="https://brunomoyse.be" rel="noopener noreferrer" target="_blank">
                                brunomoyse
                            </a>
                        </div>
                    </div>
